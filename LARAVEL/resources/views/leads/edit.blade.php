<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm">
            ...
            <a href="{{ route('leads.show', $lead) }}" class="text-slate-600 hover:text-slate-400 transition-colors font-mono">{{ $lead->nombre }}</a>
            <span class="text-slate-700">/</span>
    ...
    <div class="max-w-3xl">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-0.5">{{ $lead->nombre }}</p>
            </div>
