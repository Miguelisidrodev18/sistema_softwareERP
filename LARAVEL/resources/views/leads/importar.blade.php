<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm">
            ...
            <span class="text-white font-semibold">Importar Excel</span>
        </div>
    </x-slot>
    ...
    <div class="max-w-2xl">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-xl font-bold text-white">Importar leads desde Excel</h2>
                <p class="text-sm text-slate-500 mt-0.5">Sube un archivo con varios leads a la vez</p>
            </div>
        ...
        <div class="bg-slate-900 border border-slate-800/60 rounded-2xl p-6 mb-6">
            ...
            <p class="text-sm text-slate-500 mb-4">
                Usa este formato exacto (columnas: nombre, empresa, telefono, email). Solo "nombre" es obligatorio.
            </p>
            <a href="{{ route('leads.plantilla') }}"
        ...
        <div class="bg-slate-900 border border-slate-800/60 rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('leads.importar.store') }}" enctype="multipart/form-data"
