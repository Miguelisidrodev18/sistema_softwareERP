    ...
    <style>
        ...
        *::after {
        ...
        .bg-grid {
            ...
            opacity: .18;
            background-image:
                linear-gradient(rgba(115, 198, 245, .06) 1px, transparent 1px),
                linear-gradient(90deg, rgba(115, 198, 245, .06) 1px, transparent 1px);
        ...
        nav {
            ...
            border-bottom: 1px solid rgba(115, 198, 245, .08);
        ...
        @keyframes logoGlow {
            0%,
            100% {
                filter: drop-shadow(0 0 4px rgba(0, 200, 195, .6)) drop-shadow(0 0 8px rgba(37, 87, 204, .35));
            }
            50% {
                filter: drop-shadow(0 0 14px rgba(0, 228, 215, .92)) drop-shadow(0 0 28px rgba(0, 180, 200, .5)) drop-shadow(0 0 44px rgba(37, 87, 204, .28));
            }
        }
        ...
        /* --- Botones de la derecha en el nav --- */
        .nav-buttons {
            display: flex;
            align-items: center;
            gap: 0.75rem;
        ...
        /* Botón Demo Gratuita (estilo original) */
        .btn-nav {
            font-family: 'Inter', sans-serif;
            font-size: .75rem;
            font-weight: 700;
            ...
            text-transform: uppercase;
            padding: .8rem 1.6rem;
            background: linear-gradient(180deg, rgba(0, 120, 255, .28), rgba(0, 65, 200, .42));
            color: white;
            border: 1px solid rgba(0, 190, 255, .62);
            border-radius: 6px;
            text-decoration: none;
            transition: all .3s ease;
            box-shadow: 0 0 18px rgba(0, 165, 255, .42), 0 0 35px rgba(0, 100, 220, .15);
            white-space: nowrap;
        }

        .btn-nav:hover {
            background: linear-gradient(180deg, rgba(0, 175, 255, .42), rgba(0, 100, 230, .58));
            box-shadow: 0 0 30px rgba(0, 210, 255, .62);
            border-color: rgba(0, 235, 255, .88);
            transform: translateY(-2px);
        }

        /* Botón Acceder ERP - Estilo dorado/amarillo, misma estructura */
        .btn-erp-nav {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            ...
            background: linear-gradient(180deg, rgba(255, 200, 0, .35), rgba(200, 150, 0, .50));
            border: 1px solid rgba(255, 215, 0, .70);
            box-shadow: 0 0 18px rgba(255, 215, 0, .40), 0 0 35px rgba(200, 150, 0, .20);
            transition: all .3s ease;
            white-space: nowrap;
        }

        .btn-erp-nav:hover {
            background: linear-gradient(180deg, rgba(255, 215, 0, .50), rgba(200, 160, 0, .70));
            box-shadow: 0 0 30px rgba(255, 215, 0, .70);
            border-color: rgba(255, 230, 50, .90);
            transform: translateY(-2px);
            color: #fff !important;
        }
        ...
        .hero {
            ...
            position: relative;
            overflow: hidden;
            background: radial-gradient(ellipse 70% 55% at 50% 42%, rgba(0, 40, 100, .38) 0%, rgba(0, 15, 50, .18) 55%, transparent 75%);
        }
        ...
        .hero-slide {
            ...
            transition: opacity .9s cubic-bezier(.22, 1, .36, 1), transform .9s ease;
            pointer-events: none;
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        .hero-badge {
            ...
            gap: 10px;
            padding: 11px 28px;
            border: 1px solid rgba(0, 210, 200, .38);
            border-radius: 999px;
            background: rgba(4, 16, 36, .88);
            font-family: 'Inter', sans-serif;
            font-size: .74rem;
            font-weight: 700;
            letter-spacing: 2px;
            color: rgba(0, 225, 215, .92);
            text-transform: uppercase;
            margin-bottom: 3rem;
            box-shadow: 0 0 30px rgba(0, 200, 195, .18), inset 0 0 20px rgba(0, 180, 180, .05);
            position: relative;
        }
        ...
        .hero-badge::after {
            ...
            width: 80%;
            height: 12px;
            background: radial-gradient(ellipse, rgba(0, 200, 195, .55) 0%, transparent 72%);
            border-radius: 50%;
            filter: blur(5px);
            pointer-events: none;
        }
        ...
        .badge-dot {
            ...
            height: 8px;
            border-radius: 50%;
            background: rgba(0, 225, 215, 1);
            box-shadow: 0 0 12px rgba(0, 210, 200, .9);
        ...
        .hero h1 {
            font-family: 'Neuropol X', 'Barlow Condensed', sans-serif;
            ...
            text-transform: uppercase;
            color: #ddf4f2;
            text-shadow: 0 0 18px rgba(0, 210, 200, .8), 0 0 40px rgba(0, 160, 200, .5), 0 0 80px rgba(0, 80, 180, .3), 0 4px 12px rgba(0, 0, 0, .98);
            margin-bottom: 1.6rem;
        }

        .hero p {
            font-size: 1.05rem;
            color: rgba(180, 220, 218, .88);
            max-width: 680px;
            margin: 0 auto 3rem;
            line-height: 1.9;
            font-weight: 400;
        ...
        .btn-primary {
            ...
            text-transform: uppercase;
            padding: .9rem 2.4rem;
            background: linear-gradient(180deg, rgba(0, 130, 255, .28), rgba(0, 65, 200, .42));
            color: white;
            border: 1px solid rgba(0, 195, 255, .68);
            border-radius: 6px;
            text-decoration: none;
            display: inline-flex;
            align-items: center;
            gap: 8px;
            transition: all .3s ease;
            box-shadow: 0 0 22px rgba(0, 175, 255, .48), 0 0 45px rgba(0, 100, 220, .2), inset 0 1px 0 rgba(255, 255, 255, .1);
            cursor: pointer;
        }

        .btn-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 0 35px rgba(0, 220, 255, .68), 0 0 65px rgba(0, 150, 255, .32);
            border-color: rgba(0, 235, 255, .92);
            background: linear-gradient(180deg, rgba(0, 155, 255, .38), rgba(0, 85, 220, .52));
        }
        ...
        .btn-ghost {
            ...
            color: var(--white);
            border: 1px solid rgba(0, 175, 255, .45);
            border-radius: 6px;
            text-decoration: none;
            display: inline-flex;
            align-items: center;
            ...
            box-shadow: 0 0 15px rgba(0, 150, 255, .2), inset 0 1px 0 rgba(255, 255, 255, .05);
            cursor: pointer;
        }

        .btn-ghost:hover {
            background: rgba(0, 95, 200, .25);
            border-color: rgba(0, 220, 255, .72);
            box-shadow: 0 0 28px rgba(0, 180, 255, .38);
            transform: translateY(-2px);
        }
        ...
        .hero-dot.active {
            background: rgba(0, 220, 210, .9);
            width: 32px;
            box-shadow: 0 0 20px rgba(0, 210, 200, .7);
            border-color: rgba(0, 220, 210, .6);
        }

        /* ===== STATS ===== */
        .stats-section {
            background: linear-gradient(180deg, rgba(6, 12, 24, .84), rgba(6, 12, 24, .74));
            border-top: 1px solid rgba(115, 198, 245, .18);
            border-bottom: 1px solid rgba(115, 198, 245, .18);
            backdrop-filter: blur(28px);
            padding: 2rem;
            box-shadow: 0 0 45px rgba(37, 87, 204, .12);
        }
        ...
        .section-title {
            ...
            letter-spacing: .02em;
            text-transform: uppercase;
            background: linear-gradient(135deg, #ffffff 25%, var(--blue-light) 95%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            margin-bottom: 1rem;
        ...
        .card::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgba(115, 198, 245, .05), transparent);
            opacity: 0;
        ...
        .card:hover {
            ...
            box-shadow: 0 12px 40px rgba(37, 87, 204, .18);
        ...
        .card-icon {
            ...
            box-shadow: 0 8px 20px rgba(37, 87, 204, .3);
        }
        ...
        .plan-card.featured {
            ...
            box-shadow: 0 0 50px rgba(115, 198, 245, .15);
        }

        .plan-card:hover {
            transform: translateY(-4px);
            box-shadow: 0 16px 50px rgba(37, 87, 204, .2);
        }
        ...
        /* ===== CTA ===== */
        .cta-wrap {
            background: linear-gradient(135deg, rgba(13, 27, 62, .9), rgba(26, 58, 124, .7));
        ...
        @media (max-width: 768px) {
            ...
            /* En móvil los botones se muestran dentro del menú desplegable */
            ...
            .nav-links.open .nav-buttons-mobile .btn-nav,
            .nav-links.open .nav-buttons-mobile .btn-erp-nav {
                width: 100%;
                text-align: center;
                justify-content: center;
            }
...
<body>
    ...
    <div class="main-container">
        ...
        <nav id="navbar">
            <div class="nav-inner">
                <a href="#inicio" class="logo-wrap">
                    <div style="height:70px;display:flex;align-items:center;animation:logoGlow 3.5s ease-in-out infinite">
                        <img src="img/logo_final.png" alt="ESTELAR" height="78" style="height:78px;width:auto;display:block;object-fit:contain">
                    </div>
                </a>
                ...
                <ul class="nav-links" id="navLinks">
                    ...
                    <!-- En móvil mostramos los botones dentro del menú -->
                    <li class="nav-buttons-mobile" style="display:none;flex-direction:column;gap:0.75rem;width:100%;margin-top:1rem;">
                        <a href="#contacto" class="btn-nav" style="width:100%;text-align:center;justify-content:center;">Demo Gratuita</a>
                        <a href="/LARAVEL/public/login" class="btn-erp-nav">
                            <i class="fas fa-chart-line"></i> Acceder ERP
                        </a>
                    </li>
                </ul>
        ...
        <section class="hero" id="inicio">
            <div class="hero-slides-wrap">
                <div class="hero-slide active" id="slide-0">
                    <div class="hero-badge"><div class="badge-dot"></div> Automatización Inteligente</div>
                ...
                <div class="hero-slide" id="slide-1">
                    ...
                    <div class="hero-btns">
                        ...
                        <a href="#caracteristicas" class="btn-ghost"><i class="fas fa-info-circle"></i> Más Info</a>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="spotlight-grid">
                    <div class="card reveal">
                        ...
                        <div class="card-body">Bots que entienden lenguaje natural, aprenden de cada interacción y resuelven consultas en segundos sin intervención humana.</div>
                    </div>
                    <div class="card reveal">
                        <div class="card-icon"><i class="fas fa-plug"></i></div>
                        <div class="card-title">+50 Integraciones</div>
                        <div class="card-body">Conecta con WhatsApp, Slack, Salesforce, SAP, Google Workspace y decenas de herramientas más con un solo clic.</div>
                    </div>
                    <div class="card reveal">
                        <div class="card-icon"><i class="fas fa-shield-halved"></i></div>
                        <div class="card-title">Seguridad Enterprise</div>
                        <div class="card-body">Cifrado AES-256, autenticación multifactor, auditoría completa y cumplimiento de ISO 27001 y GDPR.</div>
                    </div>
                    <div class="card reveal">
                        <div class="card-icon"><i class="fas fa-chart-line"></i></div>
                        <div class="card-title">Analytics en Tiempo Real</div>
                        <div class="card-body">Dashboards personalizables con métricas actualizadas al instante. Toma decisiones con datos, no con intuición.</div>
                    </div>
                    <div class="card reveal">
                        <div class="card-icon"><i class="fas fa-code-branch"></i></div>
                        <div class="card-title">Workflows sin Código</div>
                        <div class="card-body">Editor visual drag-and-drop para diseñar flujos de trabajo complejos sin escribir una sola línea de código.</div>
                    </div>
                    <div class="card reveal">
                        <div class="card-icon"><i class="fas fa-headset"></i></div>
                        <div class="card-title">Soporte 24 / 7</div>
                        <div class="card-body">Equipo técnico especializado disponible a cualquier hora. Tiempo de respuesta menor a 3 minutos para incidencias críticas.</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="bots" style="padding-top:0">
            <div class="container">
                <div class="section-head center reveal">
                    ...
                    <p class="section-sub">Cada bot está especializado en su área. Despliégalos en minutos y mide resultados desde el primer día.</p>
                </div>
                <div class="bots-grid">
                    <div class="bot-card reveal">
                        <div class="bot-top"><div class="bot-avatar"><i class="fas fa-comments"></i></div><div><div class="bot-name">SupportBot Pro</div><div class="bot-role">Atención al cliente · 24/7</div></div></div>
                        ...
                        <div class="bot-tags"><span class="bot-tag">94% satisfacción</span><span class="bot-tag">&lt;2s respuesta</span></div>
                    </div>
                    <div class="bot-card reveal">
                        <div class="bot-top"><div class="bot-avatar"><i class="fas fa-chart-bar"></i></div><div><div class="bot-name">DataAnalyst AI</div><div class="bot-role">Análisis de datos · BI</div></div></div>
                        <p class="bot-desc">Procesa miles de filas de datos, genera reportes automáticos y envía alertas cuando detecta anomalías.</p>
                        <div class="bot-tags"><span class="bot-tag">10x más rápido</span><span class="bot-tag">99% precisión</span></div>
                    </div>
                    <div class="bot-card reveal">
                        <div class="bot-top"><div class="bot-avatar"><i class="fas fa-envelope"></i></div><div><div class="bot-name">EmailFlow Bot</div><div class="bot-role">Email marketing · CRM</div></div></div>
                        <p class="bot-desc">Segmenta audiencias, crea campañas personalizadas y automatiza secuencias de seguimiento post-venta.</p>
                        <div class="bot-tags"><span class="bot-tag">+35% apertura</span><span class="bot-tag">+22% conversión</span></div>
                    </div>
                    <div class="bot-card reveal">
                        <div class="bot-top"><div class="bot-avatar"><i class="fas fa-boxes-stacked"></i></div><div><div class="bot-name">InventoryAI</div><div class="bot-role">Inventario · Supply chain</div></div></div>
                        <p class="bot-desc">Predice demanda, genera órdenes de compra automáticas y evita quiebres de stock con modelos predictivos.</p>
                        <div class="bot-tags"><span class="bot-tag">-40% sobrestock</span><span class="bot-tag">98% exactitud</span></div>
                    </div>
                    <div class="bot-card reveal">
                        <div class="bot-top"><div class="bot-avatar"><i class="fas fa-file-invoice-dollar"></i></div><div><div class="bot-name">BillingBot</div><div class="bot-role">Facturación · Cobranzas</div></div></div>
                        <p class="bot-desc">Genera facturas electrónicas, envía recordatorios de pago y reporta morosidad en tiempo real.</p>
                        <div class="bot-tags"><span class="bot-tag">-60% morosidad</span><span class="bot-tag">SUNAT auto</span></div>
                    </div>
                    <div class="bot-card reveal">
                        <div class="bot-top"><div class="bot-avatar"><i class="fas fa-user-tie"></i></div><div><div class="bot-name">HRAssistant</div><div class="bot-role">RRHH · Onboarding</div></div></div>
        ...
        <section id="clientes" style="padding-top:0">
            <div class="container">
                <div class="section-head center reveal">
                    <div class="section-label"><i class="fas fa-trophy"></i> Casos de Éxito</div>
                    <h2 class="section-title">Lo que dicen nuestros clientes</h2>
                    <p class="section-sub">Empresas de todos los sectores confían en ESTELAR para transformar su operación digital.</p>
                </div>
                <div class="spotlight-grid">
                    <div class="card reveal" style="border-left:3px solid var(--blue-glow)">
                        <div style="display:flex;align-items:center;gap:12px;margin-bottom:1rem">
                            ...
                            <div><div style="font-weight:600;font-size:.9rem">María Rodríguez</div><div style="color:var(--text-muted);font-size:.78rem">Gerente Operaciones · LogisPerú</div></div>
                        </div>
                    ...
                    <div class="card reveal" style="border-left:3px solid var(--blue-glow)">
                        <div style="display:flex;align-items:center;gap:12px;margin-bottom:1rem">
                            ...
                            <div><div style="font-weight:600;font-size:.9rem">Carlos Lira</div><div style="color:var(--text-muted);font-size:.78rem">CTO · Grupo Comercial Andino</div></div>
                        </div>
                        <p style="color:var(--text-muted);font-size:.9rem;line-height:1.7;font-style:italic">"La integración con nuestro ERP fue impecable. En 3 semanas teníamos todos los procesos automatizados."</p>
                        <div style="display:flex;gap:2px;margin-top:.8rem;color:#f0d080">★★★★★</div>
                    </div>
                    <div class="card reveal" style="border-left:3px solid var(--blue-glow)">
                        <div style="display:flex;align-items:center;gap:12px;margin-bottom:1rem">
                            ...
                            <div><div style="font-weight:600;font-size:.9rem">Ana Paredes</div><div style="color:var(--text-muted);font-size:.78rem">Directora RRHH · BancoPyme</div></div>
                        </div>
        ...
        <section id="planes" style="padding-top:0">
            <div class="container">
                <div class="section-head center reveal">
                    ...
                    <p class="section-sub">Sin sorpresas. Todos los planes incluyen soporte prioritario, actualizaciones automáticas y 30 días de prueba gratuita.</p>
                </div>
                <div class="planes-grid">
                    <div class="plan-card reveal">
                        <div class="plan-name">Starter</div>
                        <div class="plan-price"><sup>S/.</sup>199</div>
                        <div class="plan-period">por mes · facturado mensualmente</div>
                    ...
                    <div class="plan-card reveal">
                        ...
                        <ul class="plan-features">
                            ...
                            <li><i class="fas fa-check"></i> Instalación on-premise</li>
                        </ul>
        ...
        <section style="padding-top:0;padding-bottom:4rem">
            <div class="container">
                <div class="cta-wrap reveal">
                    <div class="section-label" style="justify-content:center;margin-bottom:1rem"><i class="fas fa-bolt"></i> ¿Listo para empezar?</div>
                    <h2 class="section-title" style="font-size:clamp(1.8rem,4vw,3rem);margin-bottom:.8rem">Transforma tu empresa hoy</h2>
                    <p style="color:var(--text-muted);font-size:1.05rem;max-width:600px;margin:0 auto 2.5rem;line-height:1.8">Únete a más de 850 empresas que ya automatizaron sus operaciones con ESTELAR.</p>
        ...
        <section id="contacto" style="padding-top:0">
            <div class="container">
                <div class="section-head center reveal">
                    ...
                    <p class="section-sub">Nuestro equipo te responderá en menos de 2 horas hábiles con una propuesta personalizada.</p>
                </div>
                <div class="contact-form reveal">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group"><label>Teléfono</label><input type="tel" placeholder="+51 999 999 999"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <select>
                            ...
                            <option>Facturación y Cobranzas</option>
                    ...
                    <div class="form-group"><label>Mensaje</label><textarea placeholder="Cuéntanos sobre tu empresa y sus necesidades..."></textarea></div>
    ...
    <footer>
        <div class="footer-inner">
            <div class="footer-brand">
                <a href="#inicio" class="logo-wrap">
                    <div style="height:50px;display:flex;align-items:center;animation:logoGlow 3.5s ease-in-out infinite">
                        <img src="img/logo_final.png" alt="ESTELAR" height="50" style="height:50px;width:auto;display:block;object-fit:contain">
                    </div>
                </a>
                <p>Plataforma de automatización empresarial con IA. Transformamos operaciones en ventajas competitivas.</p>
        ...
        <div class="footer-bottom">
            <span>&copy; 2026 ESTELAR Software S.A.C. — Huancayo, Perú</span>
    ...
    <script>
        ...
        mobileToggle.addEventListener('click', () => {
            ...
            const mobileBtns = document.querySelector('.nav-buttons-mobile');
            if (mobileBtns) {
                mobileBtns.style.display = open ? 'flex' : 'none';
            }
        });
        document.querySelectorAll('.nav-links a').forEach(a => {
            a.addEventListener('click', () => {
                ...
                const mobileBtns = document.querySelector('.nav-buttons-mobile');
                if (mobileBtns) mobileBtns.style.display = 'none';
            });
        });
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            ...
            setTimeout(() => {
                ...
                msg.textContent = 'Recibimos tu solicitud. Te contactaremos en menos de 2 horas hábiles.';
            }, 1200);
        });
    </script>
</body>
